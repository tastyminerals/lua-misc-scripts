--[[A collection of functions for various matrix operations using simple lua tables.
Written explicitly for learning and testing.]]
...
function tastymat.pr(tabl)
  ...
  for i=1,#tabl do
    for j=1,#tabl[i] do
      io.write(stringx.ljust(tabl[i][j],maxlen))
    end
    io.write("\n")
  end
end
